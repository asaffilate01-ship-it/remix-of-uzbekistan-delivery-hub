...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Qatnov" },
      { property: "og:image", content: "https://uzbek-delivery-flow.lovable.app/og-image.jpg" },
      { property: "og:image:width", content: "1216" },
      { property: "og:image:height", content: "640" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://uzbek-delivery-flow.lovable.app/og-image.jpg" },
    ],
    links: [
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "Organization",
          name: "Qatnov",
          url: "https://uzbek-delivery-flow.lovable.app",
          logo: "https://uzbek-delivery-flow.lovable.app/favicon.png",
          description: "Uzbekistan's delivery infrastructure and merchant technology ecosystem — fleet operations, merchant SaaS, marketplace and fintech.",
          areaServed: "UZ",
        }),
      },
    ],
