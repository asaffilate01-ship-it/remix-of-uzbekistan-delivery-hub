...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Qatnov — Uzbekistan Logistics Operating System" },
      { property: "og:description", content: "3PL fleet, merchant SaaS, marketplace and fintech for Uzbekistan." },
